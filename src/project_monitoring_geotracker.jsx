...
import { projectMonitoringGeotrackerCss } from './project_monitoring_geotracker_style.ts';

function InlineStyle() { return <style>{projectMonitoringGeotrackerCss}</style>; }
